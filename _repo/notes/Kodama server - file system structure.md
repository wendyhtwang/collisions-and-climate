...
*Auto-generated by `update_kodama_structure.py` on 2026-09-18 14:16:51 CDT.*
...
│   │   ├── 08a_population_county.cpython-314.pyc
│   │   ├── aggregation_utils.cpython-314.pyc
│   │   ├── gee_extract_utils.cpython-314.pyc
│   │   ├── population_utils.cpython-314.pyc
│   │   └── weather_descriptives_utils.cpython-314.pyc
│   ├── requirements.txt
│   ├── SCRIPT_OVERVIEW.md
│   ├── test_population_logic.py
│   └── weather_descriptives_utils.py
├── codeSTATA
│   ├── 10_generate_weather_report.do
│   ├── 10_generate_weather_report.log
│   ├── build_main_data_county_year.do
│   ├── build_main_data_county_year.log
│   ├── check_animal_deer_backfill.do
│   ├── estimates_generate_collisions_weather.do
│   ├── estimates_generate_collisions_weather.log
│   ├── estimates_tables_collisions_weather.do
│   ├── estimates_tables_collisions_weather.log
│   ├── logs
│   │   ├── 10_generate_weather_report.log
│   │   ├── build_main_data_county_year.log
│   │   ├── estimates_generate_collisions_weather.log
│   │   ├── estimates_tables_collisions_weather.log
│   │   ├── regression_harvest_per1000.log
│   │   ├── regression_harvest_zscore.log
│   │   ├── regression_log_harvest.log
│   │   └── table1_log_harvest.log
│   ├── _project_main.do
│   ├── regression_harvest_per1000.do
│   ├── regression_harvest_zscore.do
│   ├── regression_log_harvest.do
...
│   │   │   ├── 08a_population_2026-09-08.log
│   │   │   ├── 08a_population_2026-09-09.log
│   │   │   ├── 08b_ct_towns_2026-09-04.log
│   │   │   └── 08b_ct_towns_2026-09-09.log
│   │   ├── population_county_year_1981_2025.csv
│   │   ├── population_county_year_1981_2025.dta
...
│   ├── data_dictionary_wildlife_18sep2026.xlsx
│   └── Population
...
│   ├── estimates
│   │   ├── collisions_weather
│   │   │   ├── animal_rate_100k_pA_c1_Wpop.ster
│   │   │   ├── animal_rate_100k_pA_c2_Wpop.ster
│   │   │   ├── animal_rate_100k_pA_c3_Wpop.ster
│   │   │   ├── animal_rate_100k_pA_c4_Wpop.ster
│   │   │   ├── animal_rate_100k_pB1_c1_Wpop.ster
│   │   │   ├── animal_rate_100k_pB1_c2_Wpop.ster
│   │   │   ├── animal_rate_100k_pB1_c3_Wpop.ster
│   │   │   ├── animal_rate_100k_pB1_c4_Wpop.ster
│   │   │   ├── animal_rate_100k_pB2_c1_Wpop.ster
│   │   │   ├── animal_rate_100k_pB2_c2_Wpop.ster
│   │   │   ├── animal_rate_100k_pB2_c3_Wpop.ster
│   │   │   ├── animal_rate_100k_pB2_c4_Wpop.ster
│   │   │   ├── animal_rate_100k_pC_c1_Wpop.ster
│   │   │   ├── animal_rate_100k_pC_c2_Wpop.ster
│   │   │   ├── animal_rate_100k_pC_c3_Wpop.ster
│   │   │   ├── animal_rate_100k_pC_c4_Wpop.ster
│   │   │   ├── animal_rate_100k_pD_c1_Wpop.ster
│   │   │   ├── animal_rate_100k_pD_c2_Wpop.ster
│   │   │   ├── animal_rate_100k_pD_c3_Wpop.ster
│   │   │   ├── animal_rate_100k_pD_c4_Wpop.ster
│   │   │   ├── animal_share_pA_c1_Wnone.ster
│   │   │   ├── animal_share_pA_c2_Wnone.ster
│   │   │   ├── animal_share_pA_c3_Wnone.ster
│   │   │   ├── animal_share_pA_c4_Wnone.ster
│   │   │   ├── animal_share_pB1_c1_Wnone.ster
│   │   │   ├── animal_share_pB1_c2_Wnone.ster
│   │   │   ├── animal_share_pB1_c3_Wnone.ster
│   │   │   ├── animal_share_pB1_c4_Wnone.ster
│   │   │   ├── animal_share_pB2_c1_Wnone.ster
│   │   │   ├── animal_share_pB2_c2_Wnone.ster
│   │   │   ├── animal_share_pB2_c3_Wnone.ster
│   │   │   ├── animal_share_pB2_c4_Wnone.ster
│   │   │   ├── animal_share_pC_c1_Wnone.ster
│   │   │   ├── animal_share_pC_c2_Wnone.ster
│   │   │   ├── animal_share_pC_c3_Wnone.ster
│   │   │   ├── animal_share_pC_c4_Wnone.ster
│   │   │   ├── animal_share_pD_c1_Wnone.ster
│   │   │   ├── animal_share_pD_c2_Wnone.ster
│   │   │   ├── animal_share_pD_c3_Wnone.ster
│   │   │   ├── animal_share_pD_c4_Wnone.ster
│   │   │   └── _run_settings.txt
│   │   └── wildlife_weather
...
│       │   └── prism_winter_temperature_distributions_by_decade_tier1.pdf
│       └── tier2
...
│           │   ├── prism_winter_temperature_early_vs_recent.pdf
│           │   └── prism_winter_warming_data_section.pdf
│           ├── report__2026_09_11.aux
│           ├── report__2026_09_11.log
│           ├── report__2026_09_11.out
│           ├── report__2026_09_11.pdf
│           ├── report__2026_09_11.tex
│           └── report__2026_09_11.toc
├── slides
└── tables
    ├── checks
    │   └── animal_deer_backfill_violations.csv
    ├── collisions_weather
    │   ├── table_collisions_weather_rate_panel_A.tex
    │   ├── table_collisions_weather_rate_panel_B.tex
    │   ├── table_collisions_weather_rate_panel_C.tex
    │   ├── table_collisions_weather_rate_panel_D.tex
    │   ├── table_collisions_weather_rate.tex
    │   ├── table_collisions_weather_share_panel_A.tex
    │   ├── table_collisions_weather_share_panel_B.tex
    │   ├── table_collisions_weather_share_panel_C.tex
    │   ├── table_collisions_weather_share_panel_D.tex
    │   └── table_collisions_weather_share.tex
    ├── merge_diagnostics
    │   ├── unmatched_collisions_by_county.csv
    │   ├── unmatched_collisions_in_window.csv
    │   ├── unmatched_era5_snow_by_county.csv
    │   ├── unmatched_era5_snow_in_window.csv
    │   ├── unmatched_population_by_county.csv
    │   ├── unmatched_population_in_window.csv
    │   ├── unmatched_wildlife_by_county.csv
    │   └── unmatched_wildlife_in_window.csv
    ├── weather
    ...
    │   │   ├── prism_county_winter_warm_anomalies_detrended_diagnostic.csv
    ...
    │   └── tier2
    │       ├── prism_annual_anomalous_warm_winter_frequency_1sd.csv
    │       ├── prism_annual_anomalous_warm_winter_frequency_2sd.csv
    │       ├── prism_annual_anomalous_warm_winter_frequency_provisional.csv
    │       ├── prism_anomaly_crosscheck_vs_merged_dta.csv
    │       ├── prism_anomaly_definition_caveats.csv
    │       ├── prism_anomaly_definition.csv
    │       ├── prism_anomaly_definition_provisional.csv
    │       ├── prism_county_anomalous_warm_winter_frequency_1sd.csv
    │       ├── prism_county_anomalous_warm_winter_frequency_2sd.csv
    │       ├── prism_county_anomalous_warm_winter_frequency_provisional.csv
    │       ├── prism_county_extreme_cold_days.csv
    │       ├── prism_county_extreme_cold_early_recent.csv
    │       ├── prism_county_mean_winter_temperature.csv
    │       ├── prism_county_season_anomalies.csv
    │       ├── prism_county_season_trends.csv
    │       ├── prism_county_temperature_early_recent.csv
    │       ├── prism_county_winter_severity_index.csv
    │       ├── prism_county_winter_warm_anomalies_1sd.csv
    │       ├── prism_county_winter_warm_anomalies_2sd.csv
    ...
    │       ├── prism_season_anomaly_correlations.csv
    │       ├── prism_season_trend_correlations.csv
    │       ├── prism_season_trend_summary.csv
    │       ├── prism_state_trend_slopes.csv
    │       ├── prism_tier2_decisions_for_eyal.csv
    │       ├── prism_tier2_exhibit_index.csv
    │       ├── prism_tier2_exhibit_notes.csv
    │       └── prism_tier2_output_manifest.csv
    └── wildlife_weather
        ├── regression_harvest_per1000.csv
        ├── regression_harvest_per1000.tex
        ├── regression_harvest_zscore.csv
        ├── regression_harvest_zscore.tex
        ├── regression_log_harvest.csv
        └── regression_log_harvest.tex

56 directories, 557 files
```
...
│   ├── logs
│   │   ├── AR_deer_harmonization.log
│   │   ├── CA_deer_harmonization.log
│   │   ├── CWD_deer_harmonization.log
│   │   ├── DE_deer_harmonization.log
│   │   ├── deer_harvest_national_append.log
│   │   ├── IN_deer_harmonization.log
│   │   ├── KY_deer_harmonization.log
│   │   ├── MD_deer_harmonization.log
│   │   ├── MO_deer_harmonization.log
│   │   ├── NC_deer_harmonization.log
│   │   ├── NY_deer_harmonization.log
│   │   ├── OH_deer_harmonization.log
│   │   ├── TN_deer_harmonization.log
│   │   ├── VA_deer_harmonization.log
│   │   ├── WI_deer_harmonization.log
│   │   └── WV_deer_harmonization.log
│   ├── MD
│   │   └── MD_deer_harmonization.do
│   ├── MO
│   │   └── MO_deer_harmonization.do
│   ├── NC
│   │   └── NC_deer_harmonizationdo.do
│   ├── NY
...
│   ├── dvcs_IL_build.log
│   ├── dvcs_IL_county_year_2009_2024.dta
│   ├── dvcs_MO_county_year_2002_2016.dta
│   ├── dvcs_MO_county_year_2002_2024.dta
