"""
Compare an independently generated GEE PRISM county-month panel against
the production prism_county_month.csv.
...
This script makes no Earth Engine calls and does no daily-to-monthly
aggregation. It compares the already-monthly GEE verification panel directly
with the production monthly panel.

Output
------
Writes comparison and summary CSVs under:
